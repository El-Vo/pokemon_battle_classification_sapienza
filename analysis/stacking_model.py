...
class RunStackingModel:
    ...
    def train_model(self, log_result: bool = False) -> StackingClassifier:
        ...
        grid = GridSearchCV(
            stacking_clf, param_grid=param_grid, cv=5, scoring="roc_auc"
        )
    ...
    def calculate_model_correlations(
        self, X: pd.DataFrame, y: pd.Series, models
    ) -> None:
        """
